...
const CACHE = 'wrr-v9';
const SHELL = ['./', 'index.html', 'app.js', 'changes.js', 'guides.js', 'manifest.webmanifest', 'vendor/polyfills.js', 'vendor/pdf.min.js', 'vendor/pdf.worker.shim.js', 'vendor/pdf.worker.min.js',
